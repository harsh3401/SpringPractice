...
class DepartmentControllerTest {
    ...
    void setUp()
    {
        department= Department.builder().departmentAddress("Ahemdabad").departmentCode("IT-01").departmentName("IT").departmentId(1L).build();
    }

    @Test
    void saveDepartment() throws Exception {
      Department  inputDepartment= Department.builder().departmentAddress("Ahemdabad").departmentCode("IT-01").departmentName("IT").build();
